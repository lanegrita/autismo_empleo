...
const Register = ({
  ...
  const registerType = searchParams?.registerType;
    ...
    <div className="grid grid-cols-12 ">
          ...
          {step === 4 && (
            <div className=" w-full max-w-[624px] ">
              ...
              <div className="flex flex-col gap-26 mt-40 ">
                ...
                {/* DropDown and Input */}
                <div className="flex flex-col md:flex-row extraSmall:flex-row extraSmall:items-end gap-20">
                  <div className="flex-1">
                    <DropDown
                      options={[
                        {
                ...
                {/* Input And DropDown */}
                <div className="flex flex-col md:flex-row  extraSmall:items-end gap-20">
                  <div className="flex-1">
                    <Input
      ...
      {registerType === "entity" && (
        <div className=" col-span-12 md:col-span-8 lg:col-span-6 flex flex-col items-center   border-x border-gris2 pt-10 px-10 pb-49">
          {/* Progressbar Container */}
          <div className="w-full">
            <FormProgressBar value={step} maxValue={3} />
          </div>
          {/* Content Container */}
          ...
          {step === 1 && (
            <div className=" w-full max-w-[624px] ">
              ...
              <div className="mt-40 flex flex-col gap-2 w-full ">
                ...
                <div className={cn("flex mb-20 gap-4 w-full ")}>
                  <LoginButton
                    title="Conecta con tu cuenta de Google"
                    icon="/images/social/google.svg"
                  />
                  <LoginButton icon="/images/social/facebook.svg" />
                  <LoginButton icon="/images/social/apple-logo.svg" />
          ...
          {step === 2 && (
            <div className=" w-full max-w-[624px] ">
              ...
              {/* Inputs Container */}
              <div className="flex flex-col sm:flex-row  sm:items-end   gap-20 mt-40 ">
                <div className="flex-1">
                  <Input placeholder="CIF" type="text" variant="simple" />
                </div>
                <div className="flex-1">
                  <DropDown
                    options={[
